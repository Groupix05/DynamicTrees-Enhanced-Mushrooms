package com.wenxin2.dtenhanced_mushrooms;
...
@Mod(DynamicTreesEnhancedMushrooms.MOD_ID)
public final class DynamicTreesEnhancedMushrooms {

    public static final String MOD_ID = "dtenhanced_mushrooms";

    public DynamicTreesEnhancedMushrooms() {
